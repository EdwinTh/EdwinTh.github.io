...
Note this is v2 of post. To see earlier versions see [here](https://github.com/EdwinTh/EdwinTh.github.io/releases).
...
Confusingly, there is also the object of class `expression`, created by the `parse()` and `expression()` functions. You should think of these as lists of names and calls. When I use the term *expression* I am referring to the concept of R code that still needs to be evaluated, not objects of class `expression`.
